...
describe("Integrated Science Objective 3.6.4 acceptance audit",()=>{
 ...
 test("renders particle-scale comparison for solution suspension and colloid",()=>{expect(explorer).toContain("spark-mixture-particle-svg");expect(explorer).toContain("Solution particle model");expect(explorer).toContain("Suspension particle model");expect(explorer).toContain("Colloid particle model");expect(explorer).toContain("mix-particle solution");expect(explorer).toContain("mix-particle suspension");expect(explorer).toContain("mix-particle colloid");expect(explorer).toContain("settles");expect(css).toContain(".spark-mixture-particle-model");});
