...
describe("Integrated Science Objective 3.6.7 acceptance audit",()=>{
 ...
 test("renders surfactant head-tail orientation around grease",()=>{expect(explorer).toContain("spark-surfactant-diagram");expect(explorer).toContain("sd-tail");expect(explorer).toContain("sd-head");expect(explorer).toContain("hydrophobic");expect(explorer).toContain("hydrophilic");expect(explorer).toContain("micelle-like droplet");expect(css).toContain(".spark-surfactant-diagram");});
