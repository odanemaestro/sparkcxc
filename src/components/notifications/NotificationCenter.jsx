...
const TYPE_META = {
  ...
  study_circle_ready: { icon: "🤝", tone: "teal", label: "Study Circle" },
  study_circle_update: { icon: "↻", tone: "purple", label: "Study Circle" },
  study_circle_report_update: { icon: "✓", tone: "green", label: "Safety review" },
  study_circle_moderation: { icon: "!", tone: "amber", label: "Study Circle" },
  child_study_circle_joined: { icon: "🤝", tone: "purple", label: "Peer learning" },
