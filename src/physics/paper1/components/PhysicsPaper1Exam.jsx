...
function Paper1Instructions({ paper, onBack, onBegin }) {
  return <main className="phy-p1-root"><div className="phy-p1-shell">
    <button type="button" className="phy-p1-primary phy-p1-back" onClick={onBack}><span aria-hidden="true">{"\u2190"}</span> Paper 1 library</button>
  ...
  return <main className="phy-p1-root"><div className="phy-p1-shell phy-p1-exam-shell">
    ...
    <div className="phy-p1-exam-layout">
      <div className="phy-p1-exam-main">
        ...
        <footer className="phy-p1-exam-footer"><button type="button" className="phy-p1-primary" disabled={currentIndex === 0} onClick={() => goTo(currentIndex - 1)}><span aria-hidden="true">{"\u2190"}</span> Previous</button><span>Question {currentIndex + 1} of 60</span>{currentIndex < paper.items.length - 1 ? <button type="button" className="phy-p1-primary" onClick={() => goTo(currentIndex + 1)}>Next question <span aria-hidden="true">{"\u2192"}</span></button> : phase === "exam" ? <button type="button" className="phy-p1-primary" onClick={() => setShowSubmitConfirm(true)}>Submit paper</button> : <button type="button" className="phy-p1-secondary" disabled>Review complete</button>}</footer>
    ...
    {phase === "review" && <div className="phy-p1-result-actions"><button type="button" className="phy-p1-primary phy-p1-back-practice" onClick={onBack}><span aria-hidden="true">{"\u2190"}</span><span>Back to Physics practice</span></button><button type="button" className="phy-p1-primary" onClick={startAnotherPaper}>Start another Paper 1</button></div>}
