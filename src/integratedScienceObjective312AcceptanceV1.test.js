...
describe("Integrated Science Objective 3.1.2 acceptance audit",()=>{
 ...
 test("covers natural and artificial satellites",()=>{expect(migration).toContain("Moon is Earth's natural satellite");expect(migration).toContain("human-made object placed in orbit");});
