...
import { applyPaper2ReasoningParts } from "./paper2ReasoningParts";
import { upgradePaper2Bank } from "./cxcMarking/adapter.js";

// The Paper 2 bank is assembled in four steps, in this order.
//
...
//   3. Add the audited reasoning pilot in paper2ReasoningParts.js. Each new
//      reasoning demand is funded from marks already inside the same question,
//      so every question keeps its published total.
//   4. Layer examiner-style M/A/B marking onto typed parts: follow-through
