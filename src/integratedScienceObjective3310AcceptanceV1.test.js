...
describe("Integrated Science Objective 3.3.10 acceptance audit",()=>{
 ...
 test("covers ear barotrauma",()=>{expect(migration).toContain("pressure outside the eardrum");expect(migration).toContain("barotrauma");expect(explorer).toContain("Ear pressure");expect(explorer).toContain("spark-diving-ear-svg");expect(explorer).toContain("de-ear-canal");expect(explorer).toContain("de-eardrum");expect(explorer).toContain("de-middle-ear");expect(explorer).toContain("Eustachian tube");expect(explorer).toContain("pressure difference bends eardrum inward");expect(explorer).toContain("air moves through Eustachian tube");});
