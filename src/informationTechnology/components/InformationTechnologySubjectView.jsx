  ...
  return (
    <main className="it-subject-view">
      <div className="it-shell">
        <button type="button" className="it-back" data-spark-action="nav" onClick={onBack}><BackIcon/><span>Back to section</span></button>
...
function SectionView({ section, onBack, onOpenTopic }) {
  ...
  return (
    <main className="it-subject-view">
      <div className="it-shell">
        <button type="button" className="it-back" data-spark-action="nav" onClick={onBack}><BackIcon/><span>All sections</span></button>
    ...
    <main className="it-subject-view">
      <div className="it-shell">
        <header className="it-hero">
          <div>
            {onBack && <button type="button" className="it-back" data-spark-action="nav" onClick={onBack}><BackIcon/><span>Back</span></button>}
