...
function ConductionView(){
  return <div className="spark-heat-conduction">
    <ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:6"><svg viewBox="0 0 860 390" role="img" aria-label="Heat conduction along a metal rod from hot to cool end">
...
function ConvectionView(){
  ...
  return <div className="spark-heat-convection">
    ...
    {medium==="water"&&<div className="spark-heat-convection-panel"><ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:28"><svg viewBox="0 0 760 420" role="img" aria-label="Convection current in heated water"><rect className="hc-beaker" x="180" y="80" width="400" height="255" rx="12"/><path className="hc-water" d="M195 130H565V320H195Z"/><path className="hc-current hot" d="M300 300Q260 240 300 170Q330 120 380 120"/><path className="hc-current top" d="M380 120Q470 120 505 180"/><path className="hc-current cool" d="M505 180Q535 245 490 300Q450 340 370 325"/><path className="hc-current bottom" d="M370 325Q325 325 300 300"/><path className="hc-flame" d="M275 390Q240 350 275 315Q285 345 305 325Q340 360 310 390Z"/><text className="hc-label" x="375" y="55" textAnchor="middle">warm water rises, cooler water sinks</text></svg></ReviewedScienceDiagram><p>Heating makes water expand slightly and become less dense. The warm water rises, while cooler denser water sinks, forming a convection current.</p></div>}
    {medium==="air"&&<div className="spark-heat-convection-panel"><ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:29"><svg viewBox="0 0 760 420" role="img" aria-label="Room convection with air conditioner high on wall"><rect className="hc-room" x="90" y="60" width="580" height="300" rx="8"/><rect className="hc-ac" x="465" y="80" width="150" height="55" rx="10"/><path className="hc-air cool" d="M520 145Q510 220 420 265Q330 315 220 300"/><path className="hc-air warm" d="M220 300Q160 240 205 160Q260 95 420 100"/><text className="hc-label" x="540" y="70" textAnchor="middle">air conditioner</text><text className="hc-small" x="320" y="335">cool dense air sinks</text><text className="hc-small" x="230" y="125">warm air rises</text></svg></ReviewedScienceDiagram><p>Placing an air conditioner high on a wall supports circulation because cooled air becomes denser and sinks while warmer air rises to be cooled.</p></div>}
    {medium==="balloon"&&<div className="spark-heat-convection-panel"><ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:30"><svg viewBox="0 0 760 420" role="img" aria-label="Hot air balloon rising as heated air becomes less dense"><ellipse className="hc-balloon" cx="380" cy="165" rx="130" ry="115"/><path className="hc-basket" d="M335 280H425L410 340H350Z"/><path className="hc-burner" d="M360 280Q380 240 400 280"/><path className="hc-rise" d="M180 310V120M580 310V120"/><text className="hc-label" x="380" y="85" textAnchor="middle">heated air expands and becomes less dense</text></svg></ReviewedScienceDiagram><p>When the air inside the balloon is heated, it expands and becomes less dense than the surrounding cooler air. The buoyant force can then lift the balloon.</p></div>}
  </div>;
}
...
function RadiationView(){
  ...
  return <div className="spark-heat-radiation">
    <div className="spark-radiation-top">
      <ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:38"><svg viewBox="0 0 820 300" role="img" aria-label="Radiation from the Sun reaching Earth through space"><circle className="hr-sun" cx="125" cy="150" r="65"/><circle className="hr-earth" cx="680" cy="150" r="70"/><path className="hr-wave" d="M210 120q35 -35 70 0t70 0t70 0t70 0t70 0"/><path className="hr-wave" d="M210 180q35 -35 70 0t70 0t70 0t70 0t70 0"/><text className="hr-label" x="400" y="65" textAnchor="middle">electromagnetic radiation crosses the vacuum of space</text></svg></ReviewedScienceDiagram>
...
function CoastalBreezeView(){
  ...
  return <div className="spark-coastal-breeze">
    ...
    <ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:53"><svg viewBox="0 0 860 450" role="img" aria-label={day?"Sea breeze during daytime":"Land breeze during night"}>
...
function VacuumFlaskView(){
  return <div className="spark-vacuum-flask">
    <ReviewedScienceDiagram site="HeatTransferApplicationsExplorer.jsx:74"><svg viewBox="0 0 820 470" role="img" aria-label="Vacuum flask showing stopper, silvered surfaces and vacuum gap"><rect className="vf-outer" x="245" y="65" width="330" height="335" rx="70"/><rect className="vf-inner" x="325" y="95" width="170" height="275" rx="45"/><rect className="vf-stop" x="340" y="35" width="140" height="80" rx="18"/><path className="vf-vacuum" d="M285 105V360M535 105V360"/><path className="vf-silver" d="M315 100V365M505 100V365"/><line className="vf-call" x1="285" y1="180" x2="110" y2="135"/><text className="vf-label" x="100" y="128" textAnchor="end">vacuum reduces conduction and convection</text><line className="vf-call" x1="315" y1="250" x2="100" y2="285"/><text className="vf-label" x="90" y="290" textAnchor="end">silvered surfaces reduce radiation</text><line className="vf-call" x1="410" y1="70" x2="650" y2="85"/><text className="vf-label" x="660" y="90">insulating stopper limits conduction and convection</text></svg></ReviewedScienceDiagram>
