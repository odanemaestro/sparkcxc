...
function MaView(){
  ...
  return <div className="spark-ma-view">
    ...
    <svg className="spark-machine-diagram" viewBox="0 0 680 270" role="img" aria-label="Lever showing load force, effort force and fulcrum">
...
function WorkView(){
  ...
  return <div className="spark-work-view">
    ...
    <svg className="spark-machine-diagram" viewBox="0 0 680 270" role="img" aria-label="Box moved by a horizontal force through a measured distance">
...
function EfficiencyView(){
  ...
  return <div className="spark-efficiency-view">
    ...
    <svg className="spark-machine-diagram" viewBox="0 0 680 280" role="img" aria-label="Energy flow through a machine showing input, useful output and energy dissipated as heat and sound">
...
function PulleyView(){
  return <div className="spark-pulley-example">
    <svg className="spark-machine-diagram" viewBox="0 0 680 330" role="img" aria-label="Pulley system showing a load rising two metres while the effort end moves six metres">
...
function InclinedPlaneView(){
  ...
  return <div className="spark-incline-view">
    ...
    <svg className="spark-machine-diagram" viewBox="0 0 680 300" role="img" aria-label="Inclined plane showing slope length and vertical height">
