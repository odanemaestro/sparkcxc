...
describe("Integrated Science Objective 3.3.6 acceptance audit",()=>{
 ...
 test("covers treatment plant stages",()=>{expect(migration).toContain("Sedimentation");expect(migration).toContain("Alum");expect(migration).toContain("Filtration");expect(migration).toContain("chlorine");expect(explorer).toContain("Treatment plant");});
